...
PLACES_RAW = [
    {
        ...
        "lat": 37.5796,
        "lng": 126.9770,
        "description": "조선 왕조를 연 1395년 창건된 정궁으로, 근정전·경회루를 중심으로 국가 의례와 왕실 생활이 펼쳐지던 조선 통치의 심장입니다. 임진왜란으로 소실된 뒤 1867년 흥선대원군이 중건하였으며, 종묘·사직과 더불어 궁중 의례의 무대였습니다. 왕실 행사에서는 종묘제례악과 정악·궁중 관현악이 격식 있게 연주되어 장엄하고 정제된 궁중 음악 문화를 대표합니다. 단청과 박석이 자아내는 우아하고 위엄 있는 분위기가 오늘날까지 이어집니다.",
        "cultural_keywords": ["왕실", "궁중", "의례", "정악", "궁중음악", "장엄", "정제", "경기"],
    ...
    },
    {
        ...
        "lat": 36.5390,
        "lng": 128.5189,
        "description": "풍산 류씨가 600여 년간 대를 이어 살아온 씨족마을로, 2010년 양동마을과 함께 유네스코 세계문화유산에 등재되었습니다. 낙동강이 마을을 'S'자로 감싸 도는 물돌이동 지형 위에 기와집과 초가가 어우러져 조선시대 양반·민중 문화가 공존합니다. 국가무형유산 하회별신굿탈놀이가 전승되는 고장으로, 탈춤과 풍물·농악 가락이 마을 공동체의 신명을 이어 왔습니다. 강과 부용대가 어우러진 풍경에는 고즈넉하면서도 흥겨운 영남 민속의 정취가 깃들어 있습니다.",
        "cultural_keywords": ["민속", "마을", "공동체", "탈놀이", "농악", "풍물", "흥겨", "영남"],
    ...
    },
    {
        ...
        "lat": 35.8148,
        "lng": 127.1527,
        "description": "700여 채의 기와집이 모인 국내 최대 한옥 군락으로, 조선 후기 완판본 출판문화가 꽃핀 '소리의 고장' 전주의 중심입니다. 판소리 명창을 가리는 전주대사습놀이가 태동한 발상지이자, 마당창극과 판소리 완창·가야금 산조 무대가 연중 펼쳐지는 호남 소리문화의 거점입니다. 골목마다 한옥 처마가 이어지는 고즈넉한 풍경 속에서 구성지고 애절한 남도 소리의 정서가 살아 숨 쉽니다. 전통 음식과 공예가 어우러져 호남 전통문화를 대표합니다.",
        "cultural_keywords": ["한옥", "판소리", "산조", "호남", "전통", "문화유산", "구성", "고즈넉"],
    ...
    },
    {
        ...
        "lat": 37.5581,
        "lng": 126.9768,
        "description": "조선 태종 대인 1414년 정부가 시전을 설치하면서 비롯된 서울 최대의 재래시장으로, 600년 넘게 민중의 생활 경제를 떠받쳐 왔습니다. 의류·잡화·먹거리 1만여 점포가 빼곡히 들어차 새벽부터 상인과 손님이 뒤섞이는 활기로 가득합니다. 예부터 장터는 흥겨운 경기 민요와 풍물·사물놀이 가락이 울려 퍼지던 민중 문화의 무대였습니다. 호객 소리와 좌판이 자아내는 생동감 넘치고 경쾌한 분위기가 도시 한복판에서 이어집니다.",
        "cultural_keywords": ["시장", "민속", "활기", "공동체", "민요", "풍물", "흥겨", "경기"],
